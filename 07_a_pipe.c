/*
Demonstrate the following programs regarding Interprocess communication (IPC) in
C:
a. Write a program that illustrates how to execute two commands concurrently
with a command pipe.?(co4)
*/
