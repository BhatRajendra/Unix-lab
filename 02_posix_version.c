/*
2. Write a program to check and display the _POSIX_VERSION constant of the system
on which it is run, and also print the POSIX defined configuration options supported on
any given system.
*/
#include <stdio.h>
#include <unistd.h>
